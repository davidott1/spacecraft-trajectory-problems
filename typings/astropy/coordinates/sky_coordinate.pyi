...
class SkyCoord(ShapedLikeNDArray):
    ...
    **keyword_args
    ...
    @property
    def frame(self): # -> BaseCoordinateFrame | ICRS:
        ...
    ...
    @property
    def shape(self): # -> tuple[()] | tuple[Any, ...]:
        ...
    ...
    def transform_to(self, frame, merge_attributes=...): # -> Self:
    ...
    def apply_space_motion(self, new_obstime=..., dt=...): # -> Self:
    ...
    def __getattr__(self, attr): # -> Self | Any | None:
        """
    ...
    def to_string(self, style=..., **kwargs): # -> str | ndarray[Any, dtype[Any]] | list[Any]:
        """
    ...
    def spherical_offsets_to(self, tocoord): # -> tuple[Any, Any]:
        r"""
    ...
    def spherical_offsets_by(self, d_lon, d_lat): # -> Self:
        """
    ...
    def match_to_catalog_sky(self, catalogcoord, nthneighbor=...): # -> tuple[Any, Any, Any]:
        """
    ...
    def match_to_catalog_3d(self, catalogcoord, nthneighbor=...): # -> tuple[Any, Any, Any]:
        """
    ...
    def search_around_sky(self, searcharoundcoords, seplimit): # -> tuple[NDArray[Any], NDArray[Any], Angle, Quantity] | tuple[NDArray[Any], NDArray[Any], Angle | Any, Quantity | Any]:
        """
    ...
    def search_around_3d(self, searcharoundcoords, distlimit): # -> tuple[NDArray[Any], NDArray[Any], Angle, Quantity] | tuple[NDArray[Any], NDArray[Any], Angle | Any, Quantity | Any]:
        """
        Searches for all coordinates in this object around a supplied set of
    ...
    def skyoffset_frame(self, rotation=...): # -> Any | SkyOffsetFrame:
        """
    ...
    def get_constellation(self, short_name=..., constellation_list=...): # -> Any | ndarray[Any, dtype[Any]]:
        """
    ...
    def to_pixel(self, wcs, origin=..., mode=...): # -> tuple[Any, Any]:
        """
    ...
    @classmethod
    def from_pixel(cls, xp, yp, wcs, origin=..., mode=...): # -> Self | SkyCoord:
        """
    ...
    @classmethod
    def guess_from_table(cls, table, **coord_kwargs): # -> Self:
        r"""
    ...
    @classmethod
    def from_name(cls, name, frame=..., parse=..., cache=...): # -> Self:
        """
