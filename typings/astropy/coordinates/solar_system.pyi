...
class solar_system_ephemeris(ScienceState):
    ...
    @classproperty
    def bodies(cls): # -> tuple[Literal['earth'], Literal['sun'], Literal['moon'], *tuple[str, ...]] | tuple[str, ...] | None:
        ...
    


def get_body_barycentric_posvel(body, time, ephemeris=...):
...
def get_body_barycentric(body, time, ephemeris=...):
