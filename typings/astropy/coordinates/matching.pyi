...
def match_coordinates_3d(matchcoord, catalogcoord, nthneighbor=..., storekdtree=...): # -> tuple[Any, Any, Any]:
    """
...
def match_coordinates_sky(matchcoord, catalogcoord, nthneighbor=..., storekdtree=...): # -> tuple[Any, Any, Any]:
    """
...
def search_around_3d(coords1, coords2, distlimit, storekdtree=...): # -> tuple[NDArray[Any], NDArray[Any], Angle, Quantity] | tuple[NDArray[Any], NDArray[Any], Angle | Any, Quantity | Any]:
    """
...
def search_around_sky(coords1, coords2, seplimit, storekdtree=...): # -> tuple[NDArray[Any], NDArray[Any], Angle, Quantity] | tuple[NDArray[Any], NDArray[Any], Angle | Any, Quantity | Any]:
    """
