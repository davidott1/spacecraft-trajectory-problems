...
class Angle(SpecificTypeQuantity):
    ...
    @property
    def hour(self): # -> float | NDArray[floating[Any]] | complex | NDArray[void] | NDArray[Any]:
        """
    ...
    def wrap_at(self, wrap_angle, inplace=...): # -> Self | None:
        """
...
class Latitude(Angle):
    ...
    def __array_ufunc__(self, *args, **kwargs): # -> tuple[tuple[tuple[Any, ...] | Angle | Any, ...] | Angle | Any, ...] | Angle:
        ...
