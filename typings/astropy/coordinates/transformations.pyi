...
def frame_attrs_from_set(frame_set): # -> dict[Any, Any]:
    """
...
def frame_comps_from_set(frame_set): # -> set[Any]:
    """
...
class TransformGraph:
    ...
    @property
    def frame_attributes(self): # -> dict[Any, Any]:
        """
    ...
    @property
    def frame_component_names(self): # -> set[Any]:
        """
        A `set` of all component names every defined within any frame class in
        this TransformGraph.
        """
    ...
    def find_shortest_path(self, fromsys, tosys): # -> tuple[list[Any], Literal[0]] | tuple[list[Any], float] | tuple[None, float]:
        """
    ...
    def transform(self, transcls, fromsys, tosys, priority=..., **kwargs): # -> Callable[..., Any]:
    ...
    @contextmanager
    def impose_finite_difference_dt(self, dt): # -> Generator[None, Any, None]:
        """
...
class FunctionTransform(CoordinateTransform):
    ...
    def __call__(self, fromcoord, toframe): # -> object:
        ...
