...
class SpectralCoord(SpectralQuantity):
    ...
    def replicate(self, value=..., unit=..., observer=..., target=..., radial_velocity=..., redshift=..., doppler_convention=..., doppler_rest=..., copy=...): # -> Self:
        """
    ...
    @property
    def observer(self): # -> Any | BaseCoordinateFrame | ICRS | SkyCoord | None:
        """
    ...
    @property
    def target(self): # -> Any | BaseCoordinateFrame | ICRS | SkyCoord | None:
        """
    ...
    def with_observer_stationary_relative_to(self, frame, velocity=..., preserve_observer_frame=...): # -> Self:
        """
    ...
    def with_radial_velocity_shift(self, target_shift=..., observer_shift=...): # -> Self:
        """
