...
class Attribute:
    ...
    def convert_input(self, value): # -> tuple[Any, Literal[False]]:
        """
    ...
    def __get__(self, instance, frame_cls=...): # -> NDArray[Any] | None:
        ...
...
class CartesianRepresentationAttribute(Attribute):
    ...
    def convert_input(self, value): # -> tuple[CartesianRepresentation, Literal[True]] | tuple[Any | list[Any], Literal[False]]:
        """
...
class QuantityAttribute(Attribute):
    ...
    def convert_input(self, value): # -> tuple[None, Literal[False]] | tuple[NDArray[Any] | Quantity, bool]:
        """
...
class EarthLocationAttribute(Attribute):
    ...
    secondary_attribute : str
        ...
        ``default is None`` and no value was supplied during initialization.
    """
    def convert_input(self, value): # -> tuple[None, Literal[False]] | tuple[EarthLocation, Literal[False]] | tuple[Any, Literal[True]]:
        """
        Checks that the input is a Quantity with the necessary units (or the
        special value ``0``).
...
class CoordinateAttribute(Attribute):
    ...
    def convert_input(self, value): # -> tuple[None, Literal[False]] | tuple[Any | BaseCoordinateFrame | ICRS, Literal[True]] | tuple[Any | SkyCoord, Literal[False]]:
        """
...
class DifferentialAttribute(Attribute):
    ...
    def convert_input(self, value): # -> tuple[None, Literal[False]] | tuple[BaseDifferential | Any, Literal[True]]:
        """
