...
def cartesian_to_spherical(x, y, z): # -> tuple[Any, Any, Any]:
    """
...
def spherical_to_cartesian(r, lat, lon): # -> tuple[Any, Any, Any]:
    """
...
_constellation_data = ...
def get_constellation(coord, short_name=..., constellation_list=...): # -> Any | ndarray[Any, dtype[Any]]:
    """
