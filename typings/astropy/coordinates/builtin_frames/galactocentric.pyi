...
class galactocentric_frame_defaults(ScienceState):
    ...
    @classmethod
    def validate(cls, value): # -> _StateProxy | dict[Any, Any]:
        ...
...
def get_matrix_vectors(galactocentric_frame, inverse=...): # -> tuple[ndarray[Any, dtype[floating[Any]]] | Any, Any]:
    """
...
def icrs_to_galactocentric(icrs_coord, galactocentric_frame): # -> tuple[ndarray[Any, dtype[floating[Any]]] | Any, Any]:
    ...

@frame_transform_graph.transform(AffineTransform, Galactocentric, ICRS)
def galactocentric_to_icrs(galactocentric_coord, icrs_frame): # -> tuple[ndarray[Any, dtype[floating[Any]]] | Any, Any]:
    ...
