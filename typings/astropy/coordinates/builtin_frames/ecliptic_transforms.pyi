...
def icrs_to_helioecliptic(from_coo, to_frame): # -> tuple[Any, Any]:
    ...

@frame_transform_graph.transform(AffineTransform, HeliocentricMeanEcliptic, ICRS)
def helioecliptic_to_icrs(from_coo, to_frame): # -> tuple[Any, Any]:
    ...
...
def icrs_to_true_helioecliptic(from_coo, to_frame): # -> tuple[Any, Any]:
    ...

@frame_transform_graph.transform(AffineTransform, HeliocentricTrueEcliptic, ICRS)
def true_helioecliptic_to_icrs(from_coo, to_frame): # -> tuple[Any, Any]:
    ...

@frame_transform_graph.transform(AffineTransform, HeliocentricEclipticIAU76, ICRS)
def ecliptic_to_iau76_icrs(from_coo, to_frame): # -> tuple[ndarray[Any, dtype[float64]] | Any, Any]:
    ...

@frame_transform_graph.transform(AffineTransform, ICRS, HeliocentricEclipticIAU76)
def icrs_to_iau76_ecliptic(from_coo, to_frame): # -> tuple[NDArray[float64] | Any, Any]:
    ...
