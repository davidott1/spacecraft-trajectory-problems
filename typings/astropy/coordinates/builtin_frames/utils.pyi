...
PIOVER2 = ...
_DEFAULT_PM = ...
def get_polar_motion(time): # -> tuple[Any, Any]:
    """
...
def get_jd12(time, scale): # -> tuple[Any, Any]:
    """
...
def get_cip(jd1, jd2): # -> tuple[Any, Any, Any]:
    """
...
def atciqz(srepr, astrom): # -> tuple[Any, Any]:
    """
...
def prepare_earth_position_vel(time): # -> tuple[Any | NDArray[float64], Any]:
    """
...
def get_offset_sun_from_barycenter(time, include_velocity=..., reverse=...):
    """
