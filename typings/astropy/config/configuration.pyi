...
class ConfigNamespace(metaclass=_ConfigNamespaceMeta):
    ...
    keys = ...
    def values(self): # -> Generator[ConfigItem, Any, None]:
        """Iterate over configuration item values."""
        ...
    
    def items(self): # -> Generator[tuple[str, ConfigItem], Any, None]:
...
class ConfigItem:
    ...
    def __get__(self, obj, objtype=...): # -> Self | None:
        ...
    ...
    @contextmanager
    def set_temp(self, value): # -> Generator[None, Any, None]:
        """
    ...
    def reload(self): # -> str | list[str | Any] | list[Any] | None:
...
def get_config(packageormod=..., reload=..., rootname=...): # -> str | list[str | Any] | list[Any] | ConfigObj:
