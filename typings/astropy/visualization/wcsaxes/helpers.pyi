...
CORNERS = ...
def add_beam(ax, header=..., major=..., minor=..., angle=..., corner=..., frame=..., borderpad=..., pad=..., **kwargs): # -> None:
    """
...
def add_scalebar(ax, length, label=..., corner=..., frame=..., borderpad=..., pad=..., **kwargs): # -> None:
    """Add a scale bar.
