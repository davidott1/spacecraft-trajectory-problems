...
class CoordinateHelper:
    ...
    @property
    def locator(self): # -> Callable[..., tuple[Quantity, Any] | tuple[Any, Any]]:
        ...
    
    @property
    def formatter(self): # -> Callable[..., list[Any] | list[str]] | Callable[..., Any | list[Any]]:
        ...
    ...
    def add_tickable_gridline(self, name, constant): # -> None:
        """
