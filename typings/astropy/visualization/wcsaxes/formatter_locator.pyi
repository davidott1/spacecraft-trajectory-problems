...
class AngleFormatterLocator(BaseFormatterLocator):
    ...
    def locator(self, value_min, value_max): # -> tuple[Quantity, Any] | tuple[Any, Any]:
        ...
    
    def formatter(self, values, spacing, format=...): # -> Any | list[Any]:
        ...
...
class ScalarFormatterLocator(BaseFormatterLocator):
    ...
    @property
    def base_spacing(self): # -> Unit | CompositeUnit | Quantity | Any | _NotImplementedType:
        ...
    
    def locator(self, value_min, value_max): # -> tuple[Quantity, Any] | tuple[Any, Any]:
        ...
    
    def formatter(self, values, spacing, format=...): # -> list[Any] | list[str]:
        ...
