...
def join_skycoord(distance, distance_func=...): # -> Callable[..., tuple[NDArray[Any], NDArray[Any]]]:
...
def join_distance(distance, kdtree_args=..., query_args=...): # -> Callable[..., tuple[NDArray[Any], NDArray[Any]]]:
...
def get_col_name_map(arrays, common_names, uniq_col_name=..., table_names=...): # -> OrderedDict[Any, list[None]]:
    """
...
def get_descrs(arrays, col_name_map): # -> list[Any]:
    """
