...
class BST:
    ...
    def find_node(self, key): # -> tuple[None, None] | tuple[Any, Any]:
        """
    ...
    def traverse(self, order=...): # -> list[Any]:
        """
    ...
    def range(self, lower, upper, bounds=...): # -> list[Any]:
        """
    ...
    def range_nodes(self, lower, upper, bounds=...): # -> list[Any]:
        """
        Return nodes in the given range.
        """
        ...
    
    def same_prefix(self, val): # -> list[Any]:
        """
