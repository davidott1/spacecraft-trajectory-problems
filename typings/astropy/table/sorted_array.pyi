...
class SortedArray:
    ...
    def find_pos(self, key, data, exact=...): # -> int:
        """
    ...
    def find(self, key): # -> list[Any] | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[signedinteger[Any]]]:
        """
    ...
    def range(self, lower, upper, bounds): # -> list[Any] | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[signedinteger[Any]]]:
        """
    ...
    def sorted_data(self): # -> Any | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[signedinteger[Any]]]:
        """
