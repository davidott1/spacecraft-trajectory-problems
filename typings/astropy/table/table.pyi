...
def descr(col): # -> tuple[Any, Any | Literal['O'], Any | tuple[()]]:
...
class TableColumns(OrderedDict):
    ...
    def isinstance(self, cls): # -> list[Any]:
        """
    ...
    def not_isinstance(self, cls): # -> list[Any]:
        """
...
class PprintIncludeExclude(TableAttribute):
    ...
    attributes.
    """
    def __get__(self, instance, owner_cls): # -> Self:
        """Get the attribute.
...
class Table:
    ...
    **kwargs : dict, optional
    ...
    def __getstate__(self): # -> tuple[OrderedDict[Any, BaseColumn | Any], Any | None]:
        ...
    ...
    def __array__(self, dtype=..., copy=...): # -> Any | ndarray[Any, dtype[float64]] | ndarray[Any, dtype[Any]]:
    ...
    def itercols(self): # -> Generator[Any | TableColumns | Row | Self, Any, None]:
        """
    ...
    def __getitem__(self, item): # -> TableColumns | Row | Self:
        ...
    ...
    def field(self, item): # -> TableColumns:
    ...
    def __ior__(self, other): # -> Self | _NotImplementedType:
        ...
    ...
    def iterrows(self, *names): # -> zip[Any]:
        """
    ...
    def argsort(self, keys=..., kind=..., reverse=...): # -> ndarray[Any, dtype[Any]] | ndarray[Any, dtype[intp]]:
        """
    ...
    @classmethod
    def from_pandas(cls, dataframe, index=..., units=...): # -> Self:
        """
