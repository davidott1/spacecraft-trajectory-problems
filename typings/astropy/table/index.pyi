...
class Index:
    ...
    def get_row_specifier(self, row_specifier): # -> tuple[int | integer[Any]] | list[Any] | ndarray[Any, Any] | range:
        """
    ...
    def find(self, key): # -> list[Any] | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[signedinteger[Any]]] | Any:
        """
    ...
    def same_prefix(self, key): # -> list[Any] | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[signedinteger[Any]]] | Any:
        """
    ...
    def same_prefix_range(self, lower, upper, bounds=...): # -> list[Any] | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[signedinteger[Any]]] | Any:
        """
    ...
    def range(self, lower, upper, bounds=...): # -> list[Any] | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[signedinteger[Any]]] | Any:
        """
    ...
    def sorted_data(self): # -> Column | Any | TableColumns | tuple[Any, ...] | Row | Table | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[signedinteger[Any]]] | list[Any]:
        """
...
class SlicedIndex:
    ...
    def sliced_coords(self, rows): # -> NDArray[signedinteger[Any]]:
        """
    ...
    def find(self, key): # -> NDArray[signedinteger[Any]]:
        ...
    
    def where(self, col_map): # -> NDArray[signedinteger[Any]]:
        ...
    
    def range(self, lower, upper): # -> NDArray[signedinteger[Any]]:
        ...
    
    def same_prefix(self, key): # -> NDArray[signedinteger[Any]]:
        ...
    
    def sorted_data(self): # -> NDArray[signedinteger[Any]]:
        ...
    
    def replace(self, row, col, val): # -> None:
        ...
    
    def get_index_or_copy(self): # -> Any:
        ...
    
    def insert_row(self, pos, vals, columns): # -> None:
        ...
    
    def get_row_specifier(self, row_specifier): # -> list[Any]:
        ...
