...
class BaseColumn(_ColumnGetitemShim, np.ndarray):
    meta = ...
    def __new__(cls, data=..., name=..., dtype=..., shape=..., length=..., description=..., unit=..., format=..., meta=..., copy=..., copy_indices=...): # -> Self | Any:
        ...
    
    @property
    def data(self): # -> ndarray[Any, Any]:
        ...
    ...
    info = ...
    def copy(self, order=..., data=..., copy_data=...): # -> Self:
        """
    ...
    def __reduce__(self): # -> tuple[Any | str, Any | str, Any]:
        """
    ...
    def __array_wrap__(self, out_arr, context=..., return_scalar=...): # -> ndarray[Any, Any] | BaseColumn:
        """
    ...
    @property
    def descr(self): # -> tuple[str | Any, Any, tuple[int, ...]]:
    ...
    def iter_str_vals(self): # -> Generator[Any | str, Any, None]:
        """
    ...
    def pformat(self, max_lines=..., show_name=..., show_unit=..., show_dtype=..., html=...): # -> list[str | Any]:
    ...
    def to(self, unit, equivalencies=..., **kwargs): # -> Quantity | Any:
        """
...
class Column(BaseColumn):
    ...
    __ge__ = ...
    __le__ = ...
    def insert(self, obj, values, axis=...): # -> Self:
        """
...
class MaskedColumn(Column, _MaskedColumnGetitemShim, ma.MaskedArray):
    ...
    def filled(self, fill_value=...): # -> Column | Any:
