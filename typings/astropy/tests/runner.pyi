...
class TestRunnerBase:
    ...
    @classmethod
    def make_test_runner_in(cls, path): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
        """
...
class TestRunner(TestRunnerBase):
    ...
    """
    def packages_path(self, packages, base_path, error=..., warning=...): # -> list[Any]:
        """
    ...
    def coverage(self, coverage, kwargs): # -> list[Any]:
        ...
    
    @keyword(priority=1)
    def package(self, package, kwargs): # -> list[Any]:
        """
    ...
    @keyword()
    def test_path(self, test_path, kwargs): # -> list[Any]:
        """
    ...
    @keyword()
    def args(self, args, kwargs): # -> list[str] | list[Any]:
        """
        args : str, optional
    ...
    @keyword(default_value=[])
    def plugins(self, plugins, kwargs): # -> list[Any]:
        """
    ...
    @keyword()
    def verbose(self, verbose, kwargs): # -> list[str] | list[Any]:
        """
    ...
    @keyword()
    def pastebin(self, pastebin, kwargs): # -> list[str] | list[Any]:
        """
    ...
    @keyword()
    def pep8(self, pep8, kwargs): # -> list[str] | list[Any]:
        """
        pep8 : bool, optional
    ...
    @keyword()
    def pdb(self, pdb, kwargs): # -> list[str] | list[Any]:
        """
        pdb : bool, optional
    ...
    @keyword(0)
    def parallel(self, parallel, kwargs): # -> list[str] | list[Any]:
        """
    ...
    @keyword()
    def docs_path(self, docs_path, kwargs): # -> list[Any]:
        """
    ...
    @keyword()
    def skip_docs(self, skip_docs, kwargs): # -> list[Any]:
        """
    ...
    @keyword()
    def repeat(self, repeat, kwargs): # -> list[str] | list[Any]:
        """
        repeat : `int`, optional
