...
def solar_system_body_frame(object_name, representation_type): # -> type[_]:
    ...

@lru_cache(maxsize=100)
def solar_system_body_representation_type(object_name, baserepresentation, equatorial_radius, flattening): # -> type[_]:
    ...
...
def wcs_to_celestial_frame(wcs): # -> FK4 | FK4NoETerms | FK5 | ICRS | Galactic | ITRS | type[_]:
    """
...
def skycoord_to_pixel(coords, wcs, origin=..., mode=...): # -> tuple[Any, Any]:
    """
