...
def sanitize_slices(slices, ndim): # -> list[Any]:
    """
...
def combine_slices(slice1, slice2): # -> Integral | slice[Any, Any, Any]:
    """
...
class SlicedLowLevelWCS(BaseWCSWrapper):
    ...
    @lazyproperty
    def dropped_world_dimensions(self): # -> dict[Any, list[Any]]:
        """
    ...
    def pixel_to_world_values(self, *pixel_arrays): # -> ndarray[Any, Any] | list[Any | ndarray[Any, Any]]:
        ...
    
    def world_to_pixel_values(self, *world_arrays): # -> <subclass of list and ndarray> | tuple[Any, ...]:
        ...
    ...
    @property
    def world_axis_object_classes(self): # -> dict[Any, Any]:
        ...
    
    @property
    def array_shape(self): # -> _Shape | None:
        ...
