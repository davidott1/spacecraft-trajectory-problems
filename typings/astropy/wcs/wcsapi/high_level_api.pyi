...
def default_order(components): # -> list[Any]:
    ...
...
def high_level_objects_to_values(*world_objects, low_level_wcs): # -> list[Any]:
    """
...
def values_to_high_level_objects(*world_values, low_level_wcs): # -> list[Any]:
    """
...
class HighLevelWCSMixin(BaseHighLevelWCS):
    ...
    def pixel_to_world(self, *pixel_arrays): # -> list[Any]:
        ...
