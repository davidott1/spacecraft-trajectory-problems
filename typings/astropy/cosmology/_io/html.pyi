...
"""
_FORMAT_TABLE = ...
def read_html_table(filename, index=..., *, move_to_meta=..., cosmology=..., latex_names=..., **kwargs):
...
def write_html_table(cosmology, file, *, overwrite=..., cls=..., latex_names=..., **kwargs): # -> None:
...
def html_identify(origin, filepath, fileobj, *args, **kwargs): # -> bool:
