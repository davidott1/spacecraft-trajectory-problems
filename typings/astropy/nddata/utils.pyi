...
def overlap_slices(large_array_shape, small_array_shape, position, mode=...): # -> tuple[tuple[slice[int, int, Any], ...], tuple[slice[int, int, Any], ...]]:
    """
...
def extract_array(array_large, shape, position, mode=..., fill_value=..., return_position=...): # -> tuple[NDArray[float64] | Any, tuple[Any, ...]] | NDArray[float64]:
    """
...
class Cutout2D:
    ...
    def to_original_position(self, cutout_position): # -> tuple[Any, ...]:
        """
    ...
    def to_cutout_position(self, original_position): # -> tuple[Any, ...]:
        """
    ...
    @lazyproperty
    def origin_original(self): # -> tuple[int, int]:
        """
    ...
    @lazyproperty
    def origin_cutout(self): # -> tuple[int, int]:
        """
        The ``(x, y)`` index of the origin pixel of the cutout with
    ...
    @lazyproperty
    def center_original(self): # -> tuple[Any, ...]:
        """
    ...
    @lazyproperty
    def center_cutout(self): # -> tuple[Any, ...]:
        """
        The central ``(x, y)`` position of the cutout array with respect
