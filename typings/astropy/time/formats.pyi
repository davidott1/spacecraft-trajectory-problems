...
class TimeFormat:
    ...
    @property
    def jd1(self): # -> NDArray[Any] | ndarray[Any, Any] | None:
        ...
    ...
    @property
    def jd2(self): # -> NDArray[Any] | ndarray[Any, Any] | None:
        ...
    ...
    @classmethod
    @functools.cache
    def fill_value(cls, subfmt): # -> Masked | ndarray[Any, Any]:
        """
    ...
    @property
    def scale(self): # -> Literal['tai', 'tcb', 'tcg', 'tdb', 'tt', 'ut1', 'utc', 'local']:
        """Time scale."""
        ...
...
class TimeNumeric(TimeFormat):
    subfmts = ...
    def to_value(self, jd1=..., jd2=..., parent=..., out_subfmt=...):
        """
...
class TimeFromEpoch(TimeNumeric):
    ...
    def to_value(self, parent=..., **kwargs):
        ...
...
class TimePlotDate(TimeFromEpoch):
    ...
    epoch_format = ...
    @lazyproperty
    def epoch(self): # -> Time | Callable[[], Time]:
        """Reference epoch time from which the time interval is measured."""
        ...
...
class TimeAstropyTime(TimeUnique):
    ...
    """
    name = ...
    def __new__(cls, val1, val2, scale, precision, in_subfmt, out_subfmt, from_jd=...): # -> TimeUnique | Any:
        """
...
class TimeDatetime(TimeUnique):
    ...
    def to_value(self, timezone=..., leap_second_strict=..., parent=..., out_subfmt=...): # -> NDArray[Any]:
        """
...
class TimeYMDHMS(TimeUnique):
    ...
    @property
    def value(self): # -> recarray[Any, Any]:
        ...
...
class TimeString(TimeUnique):
    ...
    **Fast C-based parser**
    ...
    def get_jds_python(self, val1, val2): # -> tuple[Any, Any]:
        """Parse the time strings contained in val1 and get jd1, jd2."""
        ...
    
    def get_jds_fast(self, val1, val2): # -> tuple[Any, Any]:
        """Use fast C parser to parse time strings in val1 and get jd1, jd2."""
        ...
    
    def str_kwargs(self): # -> Generator[dict[str, Any], Any, None]:
        """
    ...
    @property
    def value(self): # -> ndarray[Any, dtype[Any]]:
        ...
...
class TimeFITS(TimeString):
    ...
    subfmts = ...
    subfmts = ...
    def parse_string(self, timestr, subfmts): # -> list[Any]:
...
class TimeDeltaQuantityString(TimeDeltaFormat, TimeUnique):
    ...
    re_float = ...
    re_ydhms = ...
    def parse_string(self, timestr): # -> list[float]:
    ...
    def to_value(self, parent=..., out_subfmt=...): # -> NDArray[Any]:
        ...
    
    def get_multi_comps(self, jd1, jd2): # -> list[str]:
        ...
