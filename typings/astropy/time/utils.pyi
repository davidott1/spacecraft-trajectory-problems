...
"""
def day_frac(val1, val2, factor=..., divisor=...): # -> tuple[Any, Any]:
...
def quantity_day_frac(val1, val2=...): # -> tuple[Any, Any] | tuple[Any, float]:
...
def two_product(a, b): # -> tuple[Any, Any]:
    """
...
def longdouble_to_twoval(val1, val2=...): # -> tuple[Any, Any]:
    ...
