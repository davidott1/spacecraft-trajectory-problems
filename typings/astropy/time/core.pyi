...
class TimeBase(ShapedLikeNDArray):
    ...
    def __getnewargs__(self): # -> tuple[TimeUnique | Any]:
        ...
    ...
    @property
    def scale(self): # -> Any | Literal['tai', 'tcb', 'tcg', 'tdb', 'tt', 'ut1', 'utc', 'local']:
        """Time scale."""
        ...
    ...
    @property
    def jd1(self): # -> Masked | ndarray[Any, Any]:
        """
    ...
    @property
    def jd2(self): # -> Masked | ndarray[Any, Any]:
        """
        Second of the two doubles that internally store time value(s) in JD.
        """
        ...
    
    def to_value(self, format, subfmt=...): # -> Masked | ndarray[Any, Any]:
    ...
    @property
    def value(self): # -> Masked | ndarray[Any, Any]:
        """Time value(s) in current format."""
        ...
    
    @property
    def mask(self): # -> NDArray[bool_] | Any | dict[Any, Any]:
        ...
    ...
    def filled(self, fill_value): # -> Self:
    ...
    def replicate(self, format=..., copy=..., cls=...): # -> Self:
        """
    ...
    def argsort(self, axis=..., kind=...): # -> Any:
    ...
    def mean(self, axis=..., dtype=..., out=..., keepdims=..., *, where=...): # -> Self:
    ...
    @lazyproperty
    def cache(self): # -> defaultdict[Any, dict[Any, Any]]:
        """
    ...
    def __getattr__(self, attr): # -> Masked | ndarray[Any, Any] | Any:
        """
        Get dynamic attributes to output format or do timescale conversion.
        """
        ...
    
    def __dir__(self): # -> list[str | Any]:
        ...
...
class Time(TimeBase):
    ...
    SCALES = ...
    FORMATS = ...
    def __new__(cls, val, val2=..., format=..., scale=..., precision=..., in_subfmt=..., out_subfmt=..., location=..., copy=...): # -> Time | Self:
        ...
    ...
    info = ...
    @classmethod
    def strptime(cls, time_string, format_string, **kwargs): # -> Self:
        """
    ...
    def strftime(self, format_spec): # -> ndarray[Any, dtype[Any]]:
        """
    ...
    delta_ut1_utc = ...
    delta_tdb_tt = ...
    def __sub__(self, other): # -> _NotImplementedType | Self | TimeDelta:
        ...
    ...
    def mean(self, axis=..., dtype=..., out=..., keepdims=..., *, where=...): # -> Masked | ndarray[Any, Any] | Any | Self:
        ...
    
    def __array_function__(self, function, types, args, kwargs): # -> _NotImplementedType | tuple[Any, ...] | object | None:
        """
    ...
    def to_datetime(self, timezone=..., leap_second_strict=...): # -> Masked | ndarray[Any, Any]:
        ...
...
class TimeDelta(TimeBase):
    ...
    FORMATS = ...
    info = ...
    def __new__(cls, val, val2=..., format=..., scale=..., precision=..., in_subfmt=..., out_subfmt=..., location=..., copy=...): # -> TimeDelta | Self:
        ...
    
    def __init__(self, val, val2=..., format=..., scale=..., *, precision=..., in_subfmt=..., out_subfmt=..., copy=...) -> None:
        ...
    
    def replicate(self, *args, **kwargs): # -> Self:
        ...
    
    def to_datetime(self): # -> Masked | ndarray[Any, Any]:
        """
        Convert to ``datetime.timedelta`` object.
        """
        ...
    
    def __add__(self, other): # -> _NotImplementedType | Time | Self | TimeDelta:
        ...
    
    def __sub__(self, other): # -> _NotImplementedType | Self | TimeDelta:
        ...
    
    def __radd__(self, other): # -> _NotImplementedType | Time | Self | TimeDelta:
        ...
    ...
    def __mul__(self, other): # -> Self | Quantity | Any | _NotImplementedType | TimeDelta:
        """Multiplication of `TimeDelta` objects by numbers/arrays."""
        ...
    
    def __rmul__(self, other): # -> Self | Quantity | Any | _NotImplementedType | TimeDelta:
        """Multiplication of numbers/arrays with `TimeDelta` objects."""
        ...
    
    def __truediv__(self, other): # -> Self | Quantity | Any | _NotImplementedType | TimeDelta:
    ...
    def to(self, unit, equivalencies=...): # -> Quantity | Any:
        """
    ...
    def to_value(self, *args, **kwargs): # -> Masked | ndarray[Any, Any]:
...
def get_mask_and_data(mask, val): # -> tuple[Any, Any]:
    """
