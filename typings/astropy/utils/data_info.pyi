...
IGNORE_WARNINGS = ...
@contextmanager
def serialize_context_as(context): # -> Generator[None, Any, None]:
...
def dtype_info_name(dtype): # -> str | Any:
...
def data_info_factory(names, funcs): # -> Callable[..., OrderedDict[Any, Any]]:
    """
...
class ParentAttribute:
    ...
    def __get__(self, instance, owner_cls): # -> Self | Any:
        ...
...
class DataInfo(metaclass=DataInfoMeta):
    ...
    info_summary_stats = ...
    def __call__(self, option=..., out=...): # -> OrderedDict[Any, Any] | None:
        """
...
class BaseColumnInfo(DataInfo):
    ...
    __slots__ = ...
    @property
    def parent_table(self): # -> object | None:
        ...
    ...
    @staticmethod
    def merge_cols_attributes(cols, metadata_conflicts, name, attrs): # -> dict[Any, Any]:
        """
