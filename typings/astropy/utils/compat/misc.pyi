...
PYTHON_LT_3_11 = ...
PYTHON_LT_3_10 = ...
@deprecated(since="5.2", message="http://bugs.python.org/issue12166 is resolved, {alternative}.", alternative="use ``sorted(super().__dir__() + ...)`` instead")
def override__dir__(f): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], list[str]]:
    """
