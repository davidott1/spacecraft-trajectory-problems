...
class IERS(QTable):
    ...
    def mjd_utc(self, jd1, jd2=...): # -> tuple[Any, Any]:
    ...
    def ut1_utc(self, jd1, jd2=..., return_status=...): # -> NDArray[Any] | list[Any]:
    ...
    def dcip_xy(self, jd1, jd2=..., return_status=...): # -> NDArray[Any] | list[Any]:
    ...
    def pm_xy(self, jd1, jd2=..., return_status=...): # -> NDArray[Any] | list[Any]:
...
class LeapSeconds(QTable):
    ...
    @classmethod
    def from_erfa(cls, built_in=...): # -> Self:
