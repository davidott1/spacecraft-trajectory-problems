...
class XMLWriter:
    ...
    def xml_cleaning_method(self, method=..., **clean_kwargs): # -> Generator[None, Any, None]:
    ...
    @contextlib.contextmanager
    def tag(self, tag, attrib=..., **extra): # -> Generator[None, Any, None]:
        """
    ...
    @staticmethod
    def object_attrs(obj, attrs): # -> dict[Any, Any]:
        """
