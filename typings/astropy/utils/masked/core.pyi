...
class Masked(NDArrayShapeMethods):
    ...
    _base_classes = ...
    _masked_classes = ...
    def __new__(cls, *args, **kwargs): # -> type[Masked] | type[MaskedArray[Any, Any]] | type[MaskedNDArray] | Any | Masked | Self:
        ...
    ...
    @classmethod
    def from_unmasked(cls, data, mask=..., copy=...): # -> Self:
...
class MaskedNDArray(Masked, np.ndarray, base_cls=np.ndarray, data_cls=np.ndarray):
    _mask = ...
    info = ...
    def __new__(cls, *args, mask=..., **kwargs): # -> type[Masked] | type[MaskedArray[Any, Any]] | type[MaskedNDArray] | Any | Masked | Self:
    ...
    def __array_function__(self, function, types, args, kwargs): # -> Any | _NotImplementedType | Masked | tuple[tuple[Any, ...] | type[Masked] | type[MaskedArray[Any, Any]] | type[MaskedNDArray] | Any | Masked, ...] | type[Masked] | type[MaskedArray[Any, Any]] | type[MaskedNDArray] | None:
        ...
    ...
    def ptp(self, axis=..., out=..., **kwargs): # -> Any:
        ...
    
    def nonzero(self): # -> tuple[Any, ...] | tuple[NDArray[intp], ...]:
        ...
    
    def compress(self, condition, axis=..., out=...): # -> Self:
        ...
    
    def repeat(self, repeats, axis=...): # -> Self:
        ...
    
    def choose(self, choices, out=..., mode=...):
        ...
    
    def argmin(self, axis=..., out=..., *, keepdims=...): # -> Any:
        ...
    
    def argmax(self, axis=..., out=..., *, keepdims=...): # -> Any:
        ...
    
    def argsort(self, axis=..., kind=..., order=..., *, stable=...): # -> Any:
    ...
    def sort(self, axis=..., kind=..., order=..., *, stable=...): # -> None:
