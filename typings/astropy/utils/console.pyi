...
def terminal_size(file=...): # -> tuple[Any, Any] | tuple[int, int] | tuple[ConfigItem | Any | Literal[25], ConfigItem | Any | Literal[80]]:
    """
...
class _mapfunc:
    ...
    def __call__(self, i_arg): # -> tuple[Any, Any]:
        ...
...
class ProgressBar:
    ...
    @classmethod
    def map(cls, function, items, multiprocess=..., file=..., step=..., ipython_widget=..., multiprocessing_start_method=...): # -> list[Any]:
    ...
    @classmethod
    def map_unordered(cls, function, items, multiprocess=..., file=..., step=..., ipython_widget=..., multiprocessing_start_method=...): # -> list[Any]:
