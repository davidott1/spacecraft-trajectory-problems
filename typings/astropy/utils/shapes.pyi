...
class ShapedLikeNDArray(NDArrayShapeMethods, metaclass=abc.ABCMeta):
    ...
    _METHOD_FUNCTIONS = ...
    def __array_function__(self, function, types, args, kwargs): # -> tuple[Any, ...] | _NotImplementedType | object | None:
...
def check_broadcast(*shapes): # -> tuple[()] | tuple[Any, ...]:
    """
...
def simplify_basic_index(basic_index, *, shape): # -> tuple[Any, ...]:
    """
