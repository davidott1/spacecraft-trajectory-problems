...
_NotFound = ...
def deprecated(since, message=..., name=..., alternative=..., pending=..., obj_type=..., warning_type=...): # -> type | MethodType | classmethod[Any, Callable[..., Any], Any] | staticmethod[Callable[..., Any], Any] | Callable[..., type | MethodType | classmethod[Any, Callable[..., Any], Any] | staticmethod[Callable[..., Any], Any] | Any]:
    """
...
def deprecated_renamed_argument(old_name, new_name, since, arg_in_kwargs=..., relax=..., pending=..., warning_type=..., alternative=..., message=...): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
...
class classproperty(property):
    ...
    re-evaluated for the subclass::
        ...
        1
    """
    def __new__(cls, fget=..., doc=..., lazy=...): # -> Callable[..., Self] | Self:
        ...
...
class lazyproperty(property):
    ...
    def __get__(self, obj, owner=...): # -> Any | Self:
        ...
...
def format_doc(docstring, *args, **kwargs): # -> Callable[..., Any]:
    """
