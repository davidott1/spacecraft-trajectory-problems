...
def get_readable_fileobj(name_or_obj, encoding=..., cache=..., show_progress=..., remote_timeout=..., sources=..., http_headers=..., *, use_fsspec=..., fsspec_kwargs=..., close_files=...):
...
@contextlib.contextmanager
def get_pkg_data_fileobj(data_name, package=..., encoding=..., cache=...): # -> Generator[Any, Any, None]:
    """
...
def get_pkg_data_filename(data_name, package=..., show_progress=..., remote_timeout=...): # -> str:
    """
    Retrieves a data file from the standard locations for the package and
...
def get_pkg_data_filenames(datadir, package=..., pattern=...): # -> Generator[str, Any, None]:
    """
...
def get_pkg_data_fileobjs(datadir, package=..., pattern=..., encoding=...): # -> Generator[Any, Any, None]:
    """
...
def get_pkg_data_path(*path, package=...): # -> str:
...
def get_free_space_in_dir(path, unit=...): # -> Quantity | Any | int:
    """
...
def download_files_in_parallel(urls, cache=..., show_progress=..., timeout=..., sources=..., multiprocessing_start_method=..., pkgname=...): # -> list[Any]:
...
def get_cached_urls(pkgname=...): # -> list[Any]:
    """
