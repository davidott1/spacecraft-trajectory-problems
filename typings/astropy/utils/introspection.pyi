...
if sys.version_info[: 2] >= (3, 10):
    ...
    def packages_distributions(): # -> dict[Any, list[Any]]:
        """
...
def minversion(module, version, inclusive=...): # -> bool:
    """
...
def find_current_module(depth=..., finddiff=...):
    """
...
def find_mod_objs(modname, onlylocals=...): # -> tuple[list[Any | str], list[Any], list[Any]]:
