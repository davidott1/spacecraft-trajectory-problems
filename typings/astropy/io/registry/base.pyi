...
class _UnifiedIORegistryBase:
    ...
    @property
    def available_registries(self): # -> dict_keys[Any, Any]:
    ...
    def delay_doc_updates(self, cls): # -> Generator[None, Any, None]:
    ...
    def identify_format(self, origin, data_class_required, path, fileobj, args, kwargs): # -> list[Any]:
