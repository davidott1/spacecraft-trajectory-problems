...
class BaseSplitter:
    ...
    def __call__(self, lines): # -> Generator[list[Any] | Any, Any, None]:
        ...
...
class DefaultSplitter(BaseSplitter):
    ...
    def __call__(self, lines): # -> Generator[list[str], Any, None]:
...
class BaseHeader:
    ...
    def process_lines(self, lines): # -> Generator[Any, Any, None]:
...
class BaseData:
    ...
    def process_lines(self, lines): # -> list[Any]:
        """
    ...
    def get_str_vals(self): # -> Generator[list[str], Any, None]:
...
def convert_numpy(numpy_type): # -> tuple[Callable[..., NDArray[Any] | Any], type[BoolType] | type[IntType] | type[FloatType] | type[StrType] | type[AllType]]:
...
class BaseReader(metaclass=MetaBaseReader):
    ...
    @property
    def comment_lines(self): # -> list[Any]:
