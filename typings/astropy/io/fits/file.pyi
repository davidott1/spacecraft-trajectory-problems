...
class _File:
    ...
    """
    def __init__(self, fileobj=..., mode=..., memmap=..., overwrite=..., cache=..., *, use_fsspec=..., fsspec_kwargs=..., decompress_in_memory=...) -> None:
        ...
    ...
    def readarray(self, size=..., offset=..., dtype=..., shape=...): # -> ndarray[Any, Any]:
        """
