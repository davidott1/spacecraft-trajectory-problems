...
class Header:
    ...
    def __getitem__(self, key): # -> Self | _HeaderCommentaryCards | None:
        ...
    ...
    @classmethod
    def fromfile(cls, fileobj, sep=..., endcard=..., padding=...):
        """
    ...
    @classmethod
    def fromtextfile(cls, fileobj, endcard=...):
        """
    ...
    def get(self, key, default=...): # -> Self | _HeaderCommentaryCards | None:
        """
    ...
    def items(self): # -> Generator[tuple[Any, Any | None], Any, None]:
    ...
    def values(self): # -> Generator[Any | None, Any, None]:
        """Like :meth:`dict.values`."""
        ...
    
    def pop(self, *args): # -> Self | _HeaderCommentaryCards | None:
        """
    ...
    def setdefault(self, key, default=...): # -> Self | _HeaderCommentaryCards | None:
...
class _BasicHeader(collections.abc.Mapping):
    ...
    def __getitem__(self, key): # -> float | str | Undefined | bool | int | complex | integer[Any] | complexfloating[Any, Any] | floating[Any] | Any | None:
        ...
    ...
    @classmethod
    def fromfile(cls, fileobj): # -> tuple[Any, Self]:
...
class _HeaderComments(_CardAccessor):
    ...
    def __getitem__(self, item): # -> Self | _HeaderComments:
        """
