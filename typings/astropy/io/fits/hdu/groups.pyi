...
class GroupData(FITS_rec):
    ...
    def __getitem__(self, key): # -> GroupData | Self | Any | ndarray[Any, dtype[Any]] | _VLF | FITS_record:
        ...
...
class GroupsHDU(PrimaryHDU, _TableLikeHDU):
    ...
    @lazyproperty
    def parnames(self): # -> list[Header | _HeaderCommentaryCards | Any | None]:
        """The names of the group parameters as described by the header."""
        ...
    
    @lazyproperty
    def columns(self): # -> Any | _AsciiColDefs | ColDefs | None:
        ...
