...
class CompImageHDU(BinTableHDU):
    ...
    def __init__(self, data=..., header=..., name=..., compression_type=..., tile_shape=..., hcomp_scale=..., hcomp_smooth=..., quantize_level=..., quantize_method=..., dither_seed=..., do_not_scale_image_data=..., uint=..., scale_back=..., tile_size=...) -> None:
        """
        Parameters
        ----------
        data : array, optional
    ...
    @lazyproperty
    def compressed_data(self): # -> FITS_rec | recarray[Any, Any]:
        ...
    ...
    @lazyproperty
    def header(self): # -> Header | CompImageHeader:
        ...
    ...
    @property
    def section(self): # -> CompImageSection:
        """
