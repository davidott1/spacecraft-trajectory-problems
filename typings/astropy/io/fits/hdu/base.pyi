...
class _BaseHDU:
    ...
    @property
    def ver(self): # -> Header | _HeaderCommentaryCards | None:
        ...
    ...
    @property
    def level(self): # -> Header | _HeaderCommentaryCards | None:
        ...
...
class _NonstandardHDU(_BaseHDU, _Verify):
    ...
    @lazyproperty
    def data(self): # -> ndarray[Any, Any] | None:
        """
...
class _ValidHDU(_BaseHDU, _Verify):
    ...
    def fileinfo(self): # -> dict[str, Any] | None:
        """
