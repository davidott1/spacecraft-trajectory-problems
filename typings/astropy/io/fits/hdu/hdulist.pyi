...
FITS_SIGNATURE = ...
def fitsopen(name, mode=..., memmap=..., save_backup=..., cache=..., lazy_load_hdus=..., ignore_missing_simple=..., *, use_fsspec=..., fsspec_kwargs=..., decompress_in_memory=..., **kwargs): # -> HDUList:
...
class HDUList(list, _Verify):
    ...
    def __iter__(self): # -> Generator[HDUList | Any, Any, None]:
        ...
    ...
    @classmethod
    def fromfile(cls, fileobj, mode=..., memmap=..., save_backup=..., cache=..., lazy_load_hdus=..., ignore_missing_simple=..., **kwargs): # -> Self:
        """
    ...
    @classmethod
    def fromstring(cls, data, **kwargs): # -> Self:
        """
    ...
    def fileinfo(self, index): # -> dict[str, Any] | None:
        """
