...
def itersubclasses(cls, _seen=...): # -> Generator[Any, Any, None]:
    """
...
def ignore_sigint(func): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]:
    """
...
def encode_ascii(s): # -> bytes | NDArray[Any] | ndarray[Any, Any]:
    ...

def decode_ascii(s): # -> str | NDArray[Any] | ndarray[Any, Any]:
    ...
...
_OSX_WRITE_LIMIT = ...
_WIN_WRITE_LIMIT = ...
def get_testdata_filepath(filename): # -> str:
    """
