...
class _ColumnFormat(_BaseColumnFormat):
    ...
    """
    def __new__(cls, format): # -> Self:
        ...
    
    @classmethod
    def from_recformat(cls, recformat): # -> Self:
...
class _AsciiColumnFormat(_BaseColumnFormat):
    ...
    """
    def __new__(cls, format, strict=...): # -> Self:
        ...
    
    @classmethod
    def from_column_format(cls, format): # -> Self:
        ...
...
class _FormatP(str):
    ...
    _format_re = ...
    _descriptor_format = ...
    def __new__(cls, dtype, repeat=..., max=...): # -> Self:
        ...
    ...
    @classmethod
    def from_tform(cls, format): # -> Self:
        ...
...
class ColDefs(NotifierMixin):
    ...
    def __new__(cls, input, ascii=...): # -> _AsciiColDefs | ColDefs | Self:
        ...
    
    def __getnewargs__(self): # -> tuple[list[Any | None]]:
        ...
    ...
    @lazyproperty
    def names(self): # -> list[Any | ColumnAttribute]:
        ...
    
    @lazyproperty
    def formats(self): # -> list[Any | ColumnAttribute]:
        ...
    
    def __getitem__(self, key): # -> Column | _AsciiColDefs | ColDefs:
        ...
    ...
    def __add__(self, other, option=...): # -> _AsciiColDefs | ColDefs:
        ...
    
    def __radd__(self, other): # -> _AsciiColDefs | ColDefs:
        ...
    
    def __sub__(self, other): # -> _AsciiColDefs | ColDefs:
        ...
    
    def add_col(self, column): # -> Self:
        """
        Append one `Column` to the column definition.
        """
        ...
    
    def del_col(self, col_name): # -> Self:
        """
    ...
    def info(self, attrib=..., output=...): # -> dict[Any, Any] | None:
        """
...
class _VLF(np.ndarray):
    ...
    def __new__(cls, input, dtype=...): # -> Self:
        """
        Parameters
        ----------
        input
