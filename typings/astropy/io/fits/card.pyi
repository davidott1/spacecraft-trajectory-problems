...
class Card(_Verify):
    ...
    @property
    def value(self): # -> float | str | Undefined | bool | int | complex | integer[Any] | complexfloating[Any, Any] | floating[Any] | Any | None:
    ...
    @property
    def rawvalue(self): # -> str | float | Undefined | bool | int | complex | integer[Any] | complexfloating[Any, Any] | floating[Any] | Any | None:
    ...
    @property
    def image(self): # -> str | LiteralString:
        """
