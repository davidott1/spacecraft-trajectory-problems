...
class FITS_rec(np.recarray):
    ...
    def __reduce__(self): # -> tuple[str | Any, str | Any, Any]:
        """
    ...
    @classmethod
    def from_columns(cls, columns, nrows=..., fill=..., character_as_bytes=...): # -> Self:
        """
    ...
    def __getitem__(self, key): # -> Any | NDArray[Any] | _VLF | _record_type | Self:
        ...
    ...
    @property
    def names(self): # -> list[Any] | Any | None:
