...
class Char(Converter):
    ...
    def parse(self, value, config=..., pos=...): # -> tuple[Any, Literal[False]]:
        ...
...
class VarArray(Array):
    ...
    def binparse(self, read): # -> tuple[Any, Literal[False]]:
        ...
...
class NumericArray(Array):
    ...
    def parse(self, value, config=..., pos=...): # -> tuple[NDArray[float64], Literal[True]] | tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]]:
        ...
    
    def parse_parts(self, parts, config=..., pos=...): # -> tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]]:
        ...
...
class FloatingPoint(Numeric):
    ...
    def output(self, value, mask): # -> str | None:
        ...
...
class Integer(Numeric):
    ...
    def parse(self, value, config=..., pos=...): # -> tuple[Any | NDArray[Any] | int, bool]:
        ...
...
class ComplexArrayVarArray(VarArray):
    ...
    """
    def parse(self, value, config=..., pos=...): # -> tuple[Any, Literal[True]] | tuple[Any, Literal[False]]:
        ...
...
class ComplexArray(NumericArray):
    ...
    def parse(self, value, config=..., pos=...): # -> tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]]:
        ...
...
class Complex(FloatingPoint, Array):
    ...
    def parse(self, value, config=..., pos=...): # -> tuple[float, Literal[True]] | tuple[complex, Any | bool]:
        ...
    
    _parse_permissive = ...
    _parse_pedantic = ...
    def parse_parts(self, parts, config=..., pos=...): # -> tuple[complex, Any | bool]:
        ...
...
class Bit(Converter):
    ...
    binary_one = ...
    binary_zero = ...
    def parse(self, value, config=..., pos=...): # -> tuple[Literal[False], Literal[True]] | tuple[bool, Literal[False]] | None:
        ...
...
class Boolean(Converter):
    ...
    binary_true = ...
    binary_false = ...
    def parse(self, value, config=..., pos=...): # -> tuple[Literal[False], Literal[True]] | tuple[bool, bool] | None:
        ...
    
    def output(self, value, mask): # -> Literal['?', 'T', 'F']:
        ...
    
    def binparse(self, read): # -> tuple[bool, bool] | None:
        ...
    
    _binparse_mapping = ...
    def binparse_value(self, value): # -> tuple[bool, bool] | None:
        ...
...
def table_column_to_votable_datatype(column): # -> dict[str, Any] | dict[str, str]:
    """
