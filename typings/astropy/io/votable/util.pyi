...
def convert_to_writable_filelike(fd, compressed=...): # -> Generator[TextIOWrapper[GzipFile] | TextIOWrapper[_WrappedBuffer] | StreamWriter | GzipFile | Any, Any, None]:
    """
...
def coerce_range_list_param(p, frames=..., numeric=...): # -> tuple[None, Literal[0]] | tuple[Any | str, int] | tuple[str, int] | tuple[str, Literal[1]]:
    """
