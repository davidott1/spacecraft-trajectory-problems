...
class AstropyLogger(Logger):
    ...
    @contextmanager
    def log_to_file(self, filename, filter_level=..., filter_origin=...): # -> Generator[None, Any, None]:
        """
    ...
    @contextmanager
    def log_to_list(self, filter_level=..., filter_origin=...): # -> Generator[list[Any], Any, None]:
        """
