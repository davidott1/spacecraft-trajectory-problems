...
class Spline1D(_Spline):
    ...
    @property
    def t(self): # -> NDArray[float64] | NDArray[Any]:
        """
        The knots vector.
        """
        ...
    ...
    @property
    def t_interior(self): # -> ndarray[Any, dtype[float64]] | ndarray[Any, dtype[Any]]:
        """
        The interior knots.
        """
        ...
    ...
    @property
    def c(self): # -> NDArray[float64] | NDArray[Any]:
        """
    ...
    @property
    def tck(self): # -> tuple[NDArray[float64] | Any | NDArray[Any], NDArray[float64] | Any | NDArray[Any], Any]:
        """
