...
class _Tabular(Model):
    ...
    @property
    def input_units(self): # -> dict[str | Any, <subclass of Unit and StructuredUnit> | StructuredUnit | Unit | UnitBase | None] | None:
        ...
    
    @property
    def return_units(self): # -> dict[str | Any, <subclass of Unit and StructuredUnit> | StructuredUnit | Unit | UnitBase | None] | None:
        ...
    ...
    def evaluate(self, *inputs): # -> list[Any]:
        """
