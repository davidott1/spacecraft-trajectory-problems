...
class PowerLaw1D(Fittable1DModel):
    ...
    @staticmethod
    def fit_deriv(x, amplitude, x_0, alpha): # -> list[Any]:
...
class BrokenPowerLaw1D(Fittable1DModel):
    ...
    @staticmethod
    def fit_deriv(x, amplitude, x_break, alpha_1, alpha_2): # -> list[Any]:
...
class SmoothlyBrokenPowerLaw1D(Fittable1DModel):
    ...
    delta = ...
    @staticmethod
    def evaluate(x, amplitude, x_break, alpha_1, alpha_2, delta): # -> Quantity | NDArray[Any]:
        """One dimensional smoothly broken power law model function."""
        ...
    
    @staticmethod
    def fit_deriv(x, amplitude, x_break, alpha_1, alpha_2, delta): # -> list[Any]:
...
class ExponentialCutoffPowerLaw1D(Fittable1DModel):
    ...
    @staticmethod
    def fit_deriv(x, amplitude, x_0, alpha, x_cutoff): # -> list[Any]:
        """
...
class LogParabola1D(Fittable1DModel):
    ...
    @staticmethod
    def fit_deriv(x, amplitude, x_0, alpha, beta): # -> list[Any]:
...
class Schechter1D(Fittable1DModel):
    ...
    def fit_deriv(self, mag, phi_star, m_star, alpha): # -> list[Any]:
        """
