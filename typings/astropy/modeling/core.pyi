...
class _ModelMeta(abc.ABCMeta):
    ...
    """
    _is_dynamic = ...
    def __new__(mcls, name, bases, members, **kwds): # -> Self:
        ...
    ...
    def __reduce__(cls): # -> str | tuple[type[Self], tuple[str, tuple[type, ...], dict[str, Any]]]:
        ...
...
class Model(metaclass=_ModelMeta):
    ...
    @property
    def input_units_strict(self): # -> dict[str | Any, bool] | dict[str, bool]:
        """
    ...
    @property
    def input_units_allow_dimensionless(self): # -> dict[str | Any, bool] | dict[str, bool]:
        """
    ...
    def __len__(self): # -> int | integer[Any] | Any:
        ...
    
    def __setattr__(self, attr, value): # -> None:
        ...
    
    def get_bounding_box(self, with_bbox=...): # -> ModelBoundingBox | _ | Any | dict[Any, Any] | object | CompoundBoundingBox | None:
        """
    ...
    def input_shape(self, inputs): # -> tuple[()] | tuple[Any, ...]:
    ...
    @property
    def param_sets(self): # -> NDArray[Any]:
        """
    ...
    @property
    def parameters(self): # -> NDArray[floating[_64Bit]]:
        """
    ...
    @property
    def bounding_box(self): # -> CompoundBoundingBox | ModelBoundingBox | _ | Any | dict[Any, Any] | object:
        r"""
    ...
    def without_units_for_data(self, **kwargs): # -> CompoundModel | Model:
        """
    ...
    def with_units_from_data(self, **kwargs): # -> Self:
        """
    ...
    def render(self, out=..., coords=...): # -> Any | NDArray[float64]:
        """
    ...
    @property
    def input_units(self): # -> dict[str | Any, Any] | None:
        """
    ...
    def prepare_inputs(self, *inputs, model_set_axis=..., equivalencies=..., **kwargs): # -> tuple[Any, tuple[list[Any]]] | tuple[list[Any], tuple[list[Any]]]:
        """
    ...
    def prepare_outputs(self, broadcasted_shapes, *outputs, **kwargs): # -> tuple[Any, ...]:
        ...
    ...
    def coerce_units(self, input_units=..., return_units=..., input_units_equivalencies=..., input_units_allow_dimensionless=...): # -> Self:
        """
...
class CompoundModel(Model):
    ...
    def evaluate(self, *args, **kw): # -> tuple[Any, ...] | Any:
        ...
    ...
    @property
    def submodel_names(self): # -> tuple[Any, ...]:
        """Return the names of submodels in a ``CompoundModel``."""
        ...
    
    @property
    def param_names(self): # -> tuple[Any, ...] | list[Any]:
    ...
    def traverse_postorder(self, include_operator=...): # -> list[Any]:
    ...
    __or__ = ...
    __and__ = ...
    def inputs_map(self): # -> dict[str | Any, tuple[Self, str | Any]] | dict[Any, Any]:
        """
    ...
    @property
    def input_units_equivalencies(self): # -> dict[str | Any, Any] | None:
        ...
    
    @property
    def input_units_allow_dimensionless(self): # -> dict[str | Any, Any]:
        ...
    
    @property
    def input_units_strict(self): # -> dict[str | Any, Any]:
        ...
    
    @property
    def return_units(self): # -> dict[str | Any, Any]:
        ...
    
    def outputs_map(self): # -> dict[str | Any, tuple[Self, str | Any]] | dict[Any, Any]:
        """
    ...
    def without_units_for_data(self, **kwargs): # -> tuple[Self, dict[Any, Any], dict[Any, Any]] | CompoundModel | Model:
        """
...
def binary_operation(binoperator, left, right): # -> tuple[Any, ...]:
    """
...
def custom_model(*args, fit_deriv=...): # -> type[_] | partial[type[_]]:
    """
