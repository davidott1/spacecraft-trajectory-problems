...
class OrthoPolynomialBase(PolynomialBase):
    ...
    **params : dict
    ...
    def invlex_coeff(self, coeffs): # -> NDArray[Any]:
        ...
    ...
    def prepare_inputs(self, x, y, **kwargs): # -> tuple[tuple[Any, Any], tuple[list[Any]]]:
        ...
...
class Chebyshev1D(_PolyDomainWindow1D):
    ...
    **params : dict
    ...
    def fit_deriv(self, x, *params): # -> NDArray[float64]:
        """
    ...
    def prepare_inputs(self, x, **kwargs): # -> tuple[tuple[Any], tuple[list[Any]]]:
        ...
...
class Hermite2D(OrthoPolynomialBase):
    ...
    **params : dict
    ...
    def fit_deriv(self, x, y, *params): # -> NDArray[Any]:
        """
...
class Polynomial2D(PolynomialModel):
    ...
    **params : dict
    ...
    def invlex_coeff(self, coeffs): # -> list[Any]:
        ...
