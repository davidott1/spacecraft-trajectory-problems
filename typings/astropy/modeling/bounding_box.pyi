...
class _Interval(_BaseInterval):
    ...
    @classmethod
    def validate(cls, interval): # -> Self:
        """
    ...
    def outside(self, _input: np.ndarray): # -> NDArray[Any]:
        """
        Parameters
        ----------
        _input : np.ndarray
    ...
    def domain(self, resolution): # -> NDArray[floating[Any]]:
        ...
...
class _BoundingDomain(abc.ABC):
    ...
    """
    def __init__(self, model, ignored: list[int] | None = ..., order: str = ...) -> None:
        ...
    ...
    def prepare_outputs(self, valid_outputs, valid_index, input_shape, fill_value): # -> list[Any]:
        """
    ...
    def evaluate(self, evaluate: Callable, inputs, fill_value): # -> tuple[Quantity | Any, ...]:
        """
...
class ModelBoundingBox(_BoundingDomain):
    ...
    """
    def __init__(self, intervals: dict[int, _Interval], model, ignored: list[int] | None = ..., order: str = ...) -> None:
        ...
    ...
    def bounding_box(self, order: str | None = ...): # -> tuple[Any, ...] | tuple[float, ...] | tuple[tuple[float, ...], ...]:
        """
    ...
    @classmethod
    def validate(cls, model, bounding_box, ignored: list | None = ..., order: str = ..., _preserve_ignore: bool = ..., **kwargs): # -> Self:
        """
    ...
    def domain(self, resolution, order: str | None = ...): # -> list[NDArray[floating[Any]] | Any]:
        ...
...
class _SelectorArgument(_BaseSelectorArgument):
    ...
    """
    def __new__(cls, index, ignore): # -> Self:
        ...
    
    @classmethod
    def validate(cls, model, argument, ignored: bool = ...): # -> Self:
        """
    ...
    def get_selector(self, *inputs): # -> tuple[Any, ...]:
        """
    ...
    def named_tuple(self, model): # -> tuple[str, bool]:
        """
...
class _SelectorArguments(tuple):
    ...
    """
    _kept_ignore = ...
    def __new__(cls, input_: tuple[_SelectorArgument], kept_ignore: list | None = ...): # -> Self:
        ...
    ...
    @classmethod
    def validate(cls, model, arguments, kept_ignore: list | None = ...): # -> Self:
        """
    ...
    def get_fixed_values(self, model, values: dict): # -> tuple[Any, ...]:
        """
        Gets the value fixed input corresponding to this argument.
    ...
    def named_tuple(self, model): # -> tuple[Any, ...]:
        """
...
class CompoundBoundingBox(_BoundingDomain):
    ...
    order : optional, str
        ...
        bounding_boxes.
    """
    def __init__(self, bounding_boxes: dict[Any, ModelBoundingBox], model, selector_args: _SelectorArguments, create_selector: Callable | None = ..., ignored: list[int] | None = ..., order: str = ...) -> None:
        ...
    ...
    @property
    def create_selector(self): # -> Callable[..., Any] | None:
        ...
    ...
    @classmethod
    def validate(cls, model, bounding_box: dict, selector_args=..., create_selector=..., ignored: list | None = ..., order: str = ..., _preserve_ignore: bool = ..., **kwarg): # -> Self:
        """
