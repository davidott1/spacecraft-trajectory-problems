...
class Parameter:
    ...
    @property
    def input_unit(self): # -> MagUnit | None:
        """Unit for the input value."""
        ...
    
    @property
    def quantity(self): # -> Any | _NotImplementedType | StructuredUnit | Quantity | Unit | UnitBase | <subclass of Unit and StructuredUnit> | CompositeUnit | UnrecognizedUnit | None:
        """
    ...
    @property
    def tied(self): # -> bool | Callable[..., object] | None:
        """
    ...
    @property
    def bounds(self): # -> tuple[Any | None, Any | None] | tuple[float | Any, float | Any]:
    ...
    @property
    def validator(self): # -> Callable[..., Self]:
        """
    ...
    def copy(self, name=..., description=..., default=..., unit=..., getter=..., setter=..., fixed=..., tied=..., min=..., max=..., bounds=..., prior=..., posterior=...): # -> Self:
        """
    ...
    def __array__(self, dtype=..., copy=...): # -> Quantity | NDArray[floating[_64Bit]]:
        ...
