...
class Pix2Sky_PlateCarree(Pix2SkyProjection, Cylindrical):
    ...
    """
    @staticmethod
    def evaluate(x, y): # -> tuple[NDArray[Any], NDArray[Any]]:
        ...
...
class Sky2Pix_PlateCarree(Sky2PixProjection, Cylindrical):
    ...
    """
    @staticmethod
    def evaluate(phi, theta): # -> tuple[NDArray[Any], NDArray[Any]]:
        ...
...
class AffineTransformation2D(Model):
    ...
    @property
    def input_units(self): # -> dict[str, Any | MagUnit] | dict[str, Any | MagUnit | None] | None:
        ...
