...
class Gaussian1D(Fittable1DModel):
    ...
    mean = ...
    stddev = ...
    def bounding_box(self, factor=...): # -> tuple[Any, Any]:
        """
    ...
    @staticmethod
    def fit_deriv(x, amplitude, mean, stddev): # -> list[Any]:
        """
    ...
    @property
    def input_units(self): # -> dict[str | Any, Any | MagUnit] | None:
        ...
...
class Gaussian2D(Fittable2DModel):
    ...
    @staticmethod
    def fit_deriv(x, y, amplitude, x_mean, y_mean, x_stddev, y_stddev, theta): # -> list[Any]:
        """Two dimensional Gaussian function derivative with respect to parameters."""
        ...
    
    @property
    def input_units(self): # -> dict[str | Any, Any | MagUnit | None] | None:
        ...
...
class Shift(Fittable1DModel):
    ...
    @staticmethod
    def fit_deriv(x, *params): # -> list[Any]:
...
class _Trigonometric1D(Fittable1DModel):
    ...
    phase = ...
    @property
    def input_units(self): # -> dict[str | Any, Any | Unit | CompositeUnit | Self | Quantity | _NotImplementedType | StructuredUnit | UnitBase] | None:
        ...
...
class Sine1D(_Trigonometric1D):
    ...
    @staticmethod
    def fit_deriv(x, amplitude, frequency, phase): # -> list[Any]:
...
class Tangent1D(_Trigonometric1D):
    ...
    def bounding_box(self): # -> Any | Unit | CompositeUnit | Self | Quantity | _NotImplementedType | StructuredUnit | UnitBase | list[Any]:
        """
        Tuple defining the default ``bounding_box`` limits,
        ``(x_low, x_high)``.
        """
...
class ArcSine1D(_InverseTrigonometric1D):
    ...
    def bounding_box(self): # -> tuple[Any, Any]:
        """
        Tuple defining the default ``bounding_box`` limits,
        ``(x_low, x_high)``.
        """
...
class Linear1D(Fittable1DModel):
    ...
    @property
    def input_units(self): # -> dict[str | Any, Any | UnitBase | CompositeUnit | Self | Quantity | _NotImplementedType | StructuredUnit | Unit] | None:
        ...
...
class Planar2D(Fittable2DModel):
    ...
    @staticmethod
    def fit_deriv(x, y, *params): # -> list[Any]:
...
class Lorentz1D(Fittable1DModel):
    ...
    @staticmethod
    def fit_deriv(x, amplitude, x_0, fwhm): # -> list[Any]:
...
class Voigt1D(Fittable1DModel):
    ...
    def fit_deriv(self, x, x_0, amplitude_L, fwhm_L, fwhm_G): # -> list[Any]:
        """
...
class Const1D(Fittable1DModel):
    ...
    @staticmethod
    def fit_deriv(x, amplitude): # -> list[Any]:
...
class Box1D(Fittable1DModel):
    ...
    @property
    def return_units(self): # -> dict[str | Any, Any | MagUnit] | None:
        ...
...
class AiryDisk2D(Fittable2DModel):
    ...
    _j1 = ...
    @classmethod
    def evaluate(cls, x, y, amplitude, x_0, y_0, radius): # -> Quantity | NDArray[floating[_64Bit]]:
...
class Moffat1D(Fittable1DModel):
    ...
    @staticmethod
    def fit_deriv(x, amplitude, x_0, gamma, alpha): # -> list[Any]:
...
class Moffat2D(Fittable2DModel):
    ...
    @staticmethod
    def fit_deriv(x, y, amplitude, x_0, y_0, gamma, alpha): # -> list[Any]:
...
class Sersic2D(Fittable2DModel):
    ...
    theta = ...
    @classmethod
    def evaluate(cls, x, y, amplitude, r_eff, n, x_0, y_0, ellip, theta, c=...):
...
class KingProjectedAnalytic1D(Fittable1DModel):
    ...
    def fit_deriv(self, x, amplitude, r_core, r_tide): # -> list[Any]:
        """
...
class Logarithmic1D(Fittable1DModel):
    ...
    @staticmethod
    def fit_deriv(x, amplitude, tau): # -> list[Any]:
        ...
