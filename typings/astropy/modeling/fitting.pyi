...
class Covariance:
    ...
    def pprint(self, max_lines, round_val): # -> LiteralString | str:
        ...
...
class _FitterMeta(abc.ABCMeta):
    ...
    """
    registry = ...
    def __new__(mcls, name, bases, members): # -> Self:
        ...
    


def fitter_unit_support(func): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
    """
...
class FittingWithOutlierRemoval:
    ...
    def __call__(self, model, x, y, z=..., weights=..., **kwargs): # -> tuple[Any, Any | Literal[False]]:
        """
        Parameters
        ----------
        model : `~astropy.modeling.FittableModel`
...
class _NonLinearLSQFitter(metaclass=_FitterMeta):
    ...
    def objective_function(self, fps, *args): # -> NDArray[Any]:
        """
        Function to minimize.
    ...
    @fitter_unit_support
    def __call__(self, model, x, y, z=..., weights=..., maxiter=..., acc=..., epsilon=..., estimate_jacobian=..., filter_non_finite=...):
        """
        Fit data to this model.
...
def model_to_fit_params(model): # -> tuple[NDArray[Any] | Any, list[int], tuple[tuple[Any, ...], ...]]:
    """
