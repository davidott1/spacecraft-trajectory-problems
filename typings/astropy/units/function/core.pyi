...
class FunctionUnitBase(metaclass=ABCMeta):
    ...
    @property
    def equivalencies(self): # -> list[tuple[Self, CompositeUnit | Unit, Callable[..., None], Callable[..., None]]]:
    ...
    def to(self, other, value=..., equivalencies=...): # -> float | NDArray[floating[Any]] | complex | None:
        """
    ...
    def __mul__(self, other): # -> Any | _NotImplementedType | StructuredUnit | Quantity | Unit | UnitBase | <subclass of Unit and StructuredUnit> | CompositeUnit | UnrecognizedUnit:
        ...
    
    def __rmul__(self, other): # -> Any | _NotImplementedType | StructuredUnit | Quantity | Unit | UnitBase | <subclass of Unit and StructuredUnit> | CompositeUnit | UnrecognizedUnit:
        ...
    
    def __truediv__(self, other): # -> Any | UnitBase | CompositeUnit | Self | Quantity | _NotImplementedType | StructuredUnit | Unit:
        ...
    
    def __rtruediv__(self, other): # -> Any | Unit | CompositeUnit | Self | Quantity | _NotImplementedType | StructuredUnit | UnitBase:
        ...
    
    def __pow__(self, power): # -> CompositeUnit | Self:
        ...
...
class FunctionQuantity(Quantity):
    ...
    @property
    def physical(self): # -> Self | Quantity | Any:
    ...
    def max(self, axis=..., out=..., keepdims=...): # -> list[Any] | tuple[Any, ...] | Any | Self | Quantity:
        ...
    
    def min(self, axis=..., out=..., keepdims=...): # -> list[Any] | tuple[Any, ...] | Any | Self | Quantity:
        ...
    
    def sum(self, axis=..., dtype=..., out=..., keepdims=...): # -> list[Any] | tuple[Any, ...] | Any | Self | Quantity:
        ...
    
    def cumsum(self, axis=..., dtype=..., out=...): # -> list[Any] | tuple[Any, ...] | Any | Self | Quantity:
        ...
    
    def clip(self, a_min, a_max, out=...): # -> list[Any] | tuple[Any, ...] | Any | Self | Quantity:
        ...
