...
class StructuredUnit:
    ...
    """
    def __new__(cls, units, names=...): # -> <subclass of Unit and StructuredUnit> | Self:
        ...
    ...
    @property
    def field_names(self): # -> tuple[list[Any | tuple[list[Any] | Any, ...]] | Any, ...]:
    ...
    @property
    def si(self): # -> NDArray[Any] | Self:
        """The `StructuredUnit` instance in SI units."""
        ...
    
    @property
    def cgs(self): # -> NDArray[Any] | Self:
        """The `StructuredUnit` instance in cgs units."""
        ...
    
    @property
    def physical_type(self): # -> NDArray[Any] | Self:
        """Physical types of all the fields."""
        ...
    
    def decompose(self, bases=...): # -> NDArray[Any] | Self:
    ...
    def to(self, other, value=..., equivalencies=...): # -> NDArray[void] | NDArray[Any]:
    ...
    __array_ufunc__ = ...
    def __mul__(self, other): # -> _NotImplementedType | Self | Quantity:
        ...
    
    def __rmul__(self, other): # -> _NotImplementedType | Self | Quantity:
        ...
