...
"""
def get_grouped_by_powers(bases, powers): # -> tuple[list[Any], list[Any]]:
    """
...
def decompose_to_known_units(unit, func): # -> str | Any | <subclass of Unit and StructuredUnit> | Unit | UnitBase | CompositeUnit | UnrecognizedUnit | StructuredUnit | _NotImplementedType | Quantity | NamedUnit:
    """
