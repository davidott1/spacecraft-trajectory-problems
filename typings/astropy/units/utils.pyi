...
def maybe_simple_fraction(p, max_denominator=...): # -> Fraction | Literal[0]:
...
def sanitize_power(p): # -> float | int | Fraction:
...
def resolve_fractions(a, b): # -> tuple[Any | Fraction | Literal[0], Fraction | Any | Literal[0]]:
    """
