...
class _UnitRegistry:
    ...
    @property
    def all_units(self): # -> set[Any]:
        ...
    
    @property
    def non_prefix_units(self): # -> set[Any]:
        ...
...
class UnitBase:
    ...
    def to_string(self, format=..., **kwargs): # -> str:
    ...
    def __truediv__(self, m): # -> Self | CompositeUnit | Quantity | Any | _NotImplementedType:
        ...
    
    def __rtruediv__(self, m): # -> Any | Self | CompositeUnit | Quantity | _NotImplementedType | StructuredUnit:
        ...
    
    def __mul__(self, m): # -> Self | UnitBase | <subclass of Unit and StructuredUnit> | Unit | CompositeUnit | UnrecognizedUnit | Quantity | Any | _NotImplementedType:
        ...
    
    def __rmul__(self, m): # -> Any | _NotImplementedType | StructuredUnit | Quantity:
        ...
    ...
    def __neg__(self): # -> Self | UnitBase | <subclass of Unit and StructuredUnit> | Unit | CompositeUnit | UnrecognizedUnit | Quantity | Any | _NotImplementedType:
        ...
    ...
    def to(self, other, value=..., equivalencies=...): # -> float | NDArray[floating[Any]] | complex:
        """
    ...
    def in_units(self, other, value=..., equivalencies=...): # -> float | NDArray[floating[Any]] | complex:
        """
    ...
    def compose(self, equivalencies=..., units=..., max_depth=..., include_prefix_units=...): # -> list[Any] | list[Self]:
        """
    ...
    def to_system(self, system): # -> list[Any]:
        """
    ...
    @property
    def physical_type(self): # -> <subclass of UnitBase* and PhysicalType> | PhysicalType:
        """
...
class NamedUnit(UnitBase):
    ...
    @property
    def short_names(self): # -> list[bytes | str] | list[Any]:
        """
...
class IrreducibleUnit(NamedUnit):
    ...
    """
    def __reduce__(self): # -> tuple[Callable[..., Any], tuple[type[Self], list[bytes | str], bool], dict[str, Any]]:
        ...
    ...
    def decompose(self, bases=...): # -> CompositeUnit | Self:
        ...
...
class _UnitMetaClass(type):
    ...
    """
    def __call__(self, s=..., represents=..., format=..., namespace=..., doc=..., parse_strict=...): # -> str | Any | <subclass of Unit and StructuredUnit> | Unit | UnitBase | CompositeUnit | UnrecognizedUnit | StructuredUnit:
        ...
...
class Unit(NamedUnit, metaclass=_UnitMetaClass):
    ...
    @property
    def represents(self): # -> str | Any | <subclass of Unit and StructuredUnit> | Unit | UnitBase | CompositeUnit | UnrecognizedUnit | StructuredUnit:
        """The unit that this named unit represents."""
        ...
    
    def decompose(self, bases=...): # -> CompositeUnit | UnrecognizedUnit | NDArray[Any] | StructuredUnit | Any:
        ...
    
    def is_unity(self): # -> bool | Any:
        ...
...
class CompositeUnit(UnitBase):
    ...
    @property
    def scale(self): # -> float | Any | complex:
        """
    ...
    @property
    def powers(self): # -> list[Any | float | int | Fraction] | list[Any] | Any:
        """
    ...
    def decompose(self, bases=...): # -> Self | CompositeUnit:
        ...
...
def unit_scale_converter(val): # -> NDArray[floating[Any]] | float | complex:
