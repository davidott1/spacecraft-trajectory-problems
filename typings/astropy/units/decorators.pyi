...
class QuantityInput:
    @classmethod
    def as_decorator(cls, func=..., **kwargs): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any] | Self:
        r"""
    ...
    def __call__(self, wrapped_function): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
        ...
