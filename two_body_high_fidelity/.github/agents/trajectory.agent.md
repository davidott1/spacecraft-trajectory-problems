---
description: "Use when working on the two_body_high_fidelity orbital mechanics propagator. Specializes in high-fidelity dynamics (J2/J3/J4, EGM2008, drag, SRP, third-body, relativity), SPICE-based frame conversions, orbit determination (EKF/RTS), propagation, schemas, YAML configs, and visualization. Knows the full architecture: src/model, src/propagation, src/orbit_determination, src/schemas, src/input, src/plot, src/verification."
...
- Do not abbreviate impulsive maneuvers as dv1 or deltav. Use descriptive delta_vel_vec or delta_vel_mag for an impulsive maneuver vector or magnitude, respectively.
