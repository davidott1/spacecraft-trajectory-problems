...
def plot_filter_smoother_error_comparison(
  ...
  time_truth = truth_result.time.grid.relative_initial
  time_filter = filter_result.time.grid.relative_initial
  time_smoother = smoother_result.time.grid.relative_initial
