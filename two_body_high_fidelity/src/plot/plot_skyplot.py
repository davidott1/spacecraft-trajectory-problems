...
def plot_skyplot(
  ...
  if hasattr(topo_truth, 'delta_time_epoch'):
    ...
    delta_time_epoch = result.time.grid.relative_initial  # From PropagationResult (compute_topocentric_coordinates_with_rates)
...
def plot_pass_timeseries(
  ...
  delta_time_epoch  = result.time.grid.relative_initial
