...
| Co-State               | $\vec{\lambda}(t)$           |                        | $\vec{\lambda} = \left[ \vec{\lambda}_r^\top \ \ \ \vec{\lambda}_v^\top \right]^\top$ |                              |                              |
...
| Dynamics               | $\vec{f}(t,\vec{x},\vec{u})$ |                        | $\vec{f} = \left[ \vec{v}^\top \ \ \  \vec{\Gamma}^\top    \right]^\top$                                                                   |                              |                              |
| Co-Dynamics            | $\vec{g}(t,\vec{x},\vec{u})$ |                        | $\vec{g} = \left[ \vec{0}^\top \ \ \ -\vec{\lambda}_r^\top \right]^\top$                                                                    |                              |                              |
