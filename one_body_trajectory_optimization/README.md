...
```math
H = \tfrac{1}{2} \frac{1}{2} (Gamma_x^2 + Gamma_y^2) + lambda_r_x r_x_dot + lambda_r_y r_y_dot + lambda_v_x v_x_dot + lambda_v_y v_y_dot
```
...
```math
H = \tfrac{1}{2} \frac{1}{2} (\Gamma_x^2 + \Gamma_y^2) + \lambda_{r_x} v_x + \lambda_{r_y} v_y + \lambda_{v_x} \Gamma_x + \lambda_{v_y} \Gamma_y
```
