...
from src.load.processor import modify_raw_input
...
def optimal_trajectory_input():
    ...
    # Input Process
    print("\nInput Process")
    input_files_folders_params = parse_read_configure()
    input_processed = modify_raw_input(input_files_folders_params)
